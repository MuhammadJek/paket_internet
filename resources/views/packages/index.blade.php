                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <span class="title font-weight-bold">Data Package</span>
                                {{-- <a href="" class="p-2 btn btn-primary"> </a> --}}
                                <button type="button" class="btn btn-primary d-flex" data-bs-toggle="modal"
                                    data-bs-target="#packageAdd">
                                    <i class="mdi mdi-package-up me-1"></i> Add
                                </button>
                                <!-- Modal -->
    ...
    <script>
        window.addEventListener('DeleteConfirmation', event => {
            ...
            Swal.fire({
                ...
                text: "Kamu akan " + event.detail.package.name + " menghapus ?",
                icon: "warning",
