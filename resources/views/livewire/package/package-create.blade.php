  <!-- Modal -->
  <div wire:ignore.self class="modal fade" id="packageAdd" tabindex="-1" aria-labelledby="packageAddLabel"
      aria-hidden="false">
      <div class="modal-dialog ">
          <div class="modal-content">
              <div class="modal-header">
                  <h1 class="modal-title fs-5" id="packageAddLabel">Create new package</h1>
                  ...
                  <div class="modal-body">
                    ...
                    @enderror"
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" wire:model="price" placeholder="contoh : 500.0000 / 9.500"
